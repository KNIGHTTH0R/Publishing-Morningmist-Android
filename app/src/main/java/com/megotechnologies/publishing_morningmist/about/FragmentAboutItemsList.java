package com.megotechnologies.publishing_morningmist.about;
...
public class FragmentAboutItemsList extends FragmentMeta implements ZCFragmentLifecycle, ZCRunnable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_about_itemslist, container, false);
        ...
        tvLoadMore.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tvLoadMore.getText().toString().contains(MainActivity.LOAD_MORE_CAPTION_END)) {
                    ...
                    thLoadMore = new Thread(FragmentAboutItemsList.this);
                    thLoadMore.setName(MainActivity.TH_NAME_LOAD_MORE);
                    thLoadMore.start();

                    threadLoadMoreChecker = new Thread(FragmentAboutItemsList.this);
            ...
            if (i >= recordsItems.size()) {
                ...
                llRow.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FragmentAboutItemDetails fragment = new FragmentAboutItemDetails();
                        ...
                        activity.fragMgr.beginTransaction()
                                .add(((ViewGroup) getView().getParent()).getId(), fragment, MainActivity.SCREEN_ABOUT_ITEM_DETAILS)
                                .addToBackStack(MainActivity.SCREEN_ABOUT_ITEM_DETAILS)
                                .commit();
