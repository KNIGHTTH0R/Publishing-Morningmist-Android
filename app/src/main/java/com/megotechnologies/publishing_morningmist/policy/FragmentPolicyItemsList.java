package com.megotechnologies.publishing_morningmist.policy;
...
import com.megotechnologies.publishing_morningmist.FragmentMeta;
import com.megotechnologies.publishing_morningmist.MainActivity;
import com.megotechnologies.publishing_morningmist.R;
import com.megotechnologies.publishing_morningmist.interfaces.ZCFragmentLifecycle;
import com.megotechnologies.publishing_morningmist.interfaces.ZCRunnable;
import com.megotechnologies.publishing_morningmist.utilities.ImageProcessingFunctions;
...
public class FragmentPolicyItemsList extends FragmentMeta implements ZCFragmentLifecycle, ZCRunnable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_policy_itemslist, container, false);
        ...
        tvLoadMore.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tvLoadMore.getText().toString().contains(MainActivity.LOAD_MORE_CAPTION_END)) {
                    ...
                    thLoadMore = new Thread(FragmentPolicyItemsList.this);
                    thLoadMore.setName(MainActivity.TH_NAME_LOAD_MORE);
                    thLoadMore.start();

                    threadLoadMoreChecker = new Thread(FragmentPolicyItemsList.this);
            ...
            if (i >= recordsItems.size()) {
                ...
                llRow.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FragmentPolicyItemDetails fragment = new FragmentPolicyItemDetails();
                        ...
                        activity.fragMgr.beginTransaction()
                                .add(((ViewGroup) getView().getParent()).getId(), fragment, MainActivity.SCREEN_POLICY_ITEM_DETAILS)
                                .addToBackStack(MainActivity.SCREEN_POLICY_ITEM_DETAILS)
                                .commit();
                ...
                paramsLL.setMargins(0, MainActivity.SPACING, 0, 0);
