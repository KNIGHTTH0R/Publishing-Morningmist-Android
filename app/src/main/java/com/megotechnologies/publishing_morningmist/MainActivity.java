package com.megotechnologies.publishing_morningmist;
...
import com.megotechnologies.publishing_morningmist.about.FragmentAboutItemsList;
import com.megotechnologies.publishing_morningmist.alerts.FragmentAlertItemsList;
import com.megotechnologies.publishing_morningmist.db.DbConnection;
import com.megotechnologies.publishing_morningmist.interfaces.ZCActivityLifecycle;
import com.megotechnologies.publishing_morningmist.interfaces.ZCRunnable;
import com.megotechnologies.publishing_morningmist.loading.FragmentLoading;
import com.megotechnologies.publishing_morningmist.policy.FragmentPolicyItemsList;
import com.megotechnologies.publishing_morningmist.news.FragmentNewsCategories;
import com.megotechnologies.publishing_morningmist.utilities.MLog;
...
public class MainActivity extends Activity implements ZCActivityLifecycle, ZCRunnable {
	...
	public static String DB_NAME = "zoncon_publishing_morningmist.db";
	...
	public static String SHARE_SUBJECT = "ZonCon Publishing App";
	public static String SHARE_CONTENT = "Thank you for downoading the ZonCon Publishing mobile app!";
	...
	public static String SHARE_ITEM_POSTFIX = "Brought to you by ZonCon Publishing!";
	...
	protected ImageView ivHeadTitle, ivHeadMenu;
	...
	public void loadShop() {
		...
		try {
			...
			fragmentTransaction = fragMgr.beginTransaction();
			FragmentNewsCategories fragmentLoc = new FragmentNewsCategories();
